...
public class StudentPassChange extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        back.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(StudentPassChange.this, MainActivity.class);
        ...
        ok.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                if (password1.getText().toString().trim().equals(password2.getText().toString().trim()) && password1.getText().toString().trim().length() >= 1 && password2.getText().toString().trim().length() >= 1)
                {
                    ...
                    if(!password[0].equals(mevcut_sifre.getText().toString()))
                    {
    ...
    private class SifreYenile extends AsyncTask<Object, Void, Object>
    {
        ...
        {
            super.onPreExecute();
            progressDialog = new ProgressDialog(StudentPassChange.this);
